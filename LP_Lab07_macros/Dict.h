#pragma once //защита от двойного подклюени€ заголовочных файлов
...
namespace Dictionary {			//пространство имЄн - область, в кот.оперед.идентификторы(имена типов,ф-ций,переменных)
